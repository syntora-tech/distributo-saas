    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Add Manually</h3>
                    <ManualRecipientForm onAdd={(recipient) => handleAddRecipients([recipient])} />
                </div>
            </div>
            {formData.recipients.length > 0 && (
                <div className="mt-8">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Recipients List ({formData.recipients.length})</h3>
